...
class ResultsManager():
    def __init__(self, file_name):
        ...
        for line in f:
            ...
            self.__setup_models.append(model)
    ...
    def write_file(self, write_num, write_result, write_layout, write_model):
        ...
        self.__setup_models[index] = write_model
    ...
    def read_file(self, read_num):
        ...
        return self.__setup_results[index], self.__setup_layout[index], self.__setup_models[index]
