...
class NeuralNetwork(nn.Module):
    def __init__(self):
        ...
        self.convolution = nn.Sequential(
            nn.Conv2d(1, 2, kernel_size=(3,3), stride=1, padding=0),            #from 28x28x1 to 26x26x2
            nn.MaxPool2d(kernel_size=(2, 2)),                                   #from 26x26x2 to 13x13x4
            nn.Conv2d(2, 4, kernel_size=(3,3), stride=1, padding=0)             #from 13x13x4 to 11x11x4
        )
...
if __name__ == "__main__":
    #Setup data
    x_train, x_test, y_train, y_test = gather_data("/home/domharrington/Documents/Practice/data/mnist_train.csv")
